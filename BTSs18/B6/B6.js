...
function typeCheckDecorator(target, key, descriptor) {
    ...
    descriptor.value = function (...args) {
        ...
        for (let i = 0; i < args.length; i++) {
            ...
            const expectedType = (_a = paramTypes[i]) === null || _a === void 0 ? void 0 : _a.name.toLowerCase();
...
let Example = (() => {
    ...
    return _a = class Example {
        ...
        (() => {
            ...
            _greet_decorators = [typeCheckDecorator];
