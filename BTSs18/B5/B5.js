...
function uppercaseDecorator(target, key, descriptor) {
...
function exclamationDecorator(target, key, descriptor) {
    const originalMethod = descriptor.value;
    descriptor.value = function (...args) {
        const result = originalMethod.apply(this, args);
        return result + '!';
...
let Example = (() => {
    ...
    return _a = class Example {
        ...
        (() => {
            ...
            _greet_decorators = [composeDecorators(uppercaseDecorator, exclamationDecorator)];
